...
import paint.PaintController.Modus;
...
public class PaintFrame extends JFrame {
	...
	JMenuBar mb;    
	JMenu datei,edit,zeichnen,farbe,info;
	JMenuItem[] idatei, iedit, izeich, ifarb, iinfo;
	ButtonGroup modi;

	public PaintFrame(String titel, JPanel panel, PaintController c) {
		super(titel);
		...
		JMenuItem[] iedit = {
				new JMenuItem("Element löschen"),
				new JMenuItem("Element wiederherstellen"),
				new JMenuItem("Element duplizieren"),
				new JMenuItem("Element verschieben"),
				new JMenuItem("Element in Home Position"),
				new JMenuItem("Elementfarbe ändern")
		};
		this.iedit = iedit;
		...
		JMenuItem[] izeich = {
				new JRadioButtonMenuItem("Freihand zeichnen"),
				new JRadioButtonMenuItem("Linien zeichnen"),
				new JRadioButtonMenuItem("Rechtecke zeichnen"),
				new JRadioButtonMenuItem("Abgerundete Rechtecke zeichnen"),
				new JRadioButtonMenuItem("Ellipsen zeichnen"),
				new JRadioButtonMenuItem("Polygone zeichnen"),
	...
	public void setStift(Color c) {
		...
		if (c.getRed()+c.getBlue()+c.getGreen() < Color.GRAY.getBlue()+Color.GRAY.getRed()+Color.GRAY.getGreen()) {
	...
	public Modus getModus() {
		...
		switch(b) {
			case -1: return Modus.none;
			case 0: return Modus.freihand;
			case 1: return Modus.linie;
			case 2: return Modus.rect;
			case 3: return Modus.abger_rect;
			case 4: return Modus.ellipse;
			case 5: return Modus.poly;
		}
	 ...
	 * 
	 * @param i bestimmt das Fenster (0... About | 1... Hilfe)
	 */
	public void open(int i) {
		...
		if (i==0) {
			...
			text = "<html>"
					...
					+ "<b>Version:</b> 04.06.2018"
					+ "<b>Autor:</b> Barbara Wiedermann und Fabio Fuchs"
					+ "<br/></br/>"
					+ "<b></b>"
					+ "</html>";
		} else {
			...
			text = "<html>"
					+ "<h2>Zeichnen:</h2>"
					+ "Man kann folgende Elemente zeichnen (Auswahl in der Menüleiste oder links):</br>"
					+ "<ul>"
